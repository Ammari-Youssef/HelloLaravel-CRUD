    ...
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 light:bg-dots-lighter light:bg-gray-900 selection:bg-red-500 selection:text-white">
        ...
        <nav class="bg-gray-900 text-white py-4">
            ...
            <nav class="container mx-auto flex justify-between items-center">
                <a href="/" class="text-2xl font-bold">Hello Laravel </a>
                <ul class="flex space-x-4">
                    <li><a href="{{route('home')}}" class="hover:text-gray-400">Home</a></li>
                    <li><a href="{{route('home.about')}}" class="hover:text-gray-400">About</a></li>
                    <li><a href="{{route('computers.index')}}" class="hover:text-gray-400">Computers</a></li>

                    <li><a href="{{route('home.contact')}}" class="hover:text-gray-400">Contact</a></li>
                    <li><a href="{{route('login.show')}}" class="hover:text-gray-400">login</a></li>
                </ul>
            </nav>
        </nav>
    </div>
